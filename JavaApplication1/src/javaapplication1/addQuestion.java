...
class addQuestion extends JFrame implements ActionListener {
    ...
    public void insert() {
        try {
            ...
            PreparedStatement stat = con.prepareStatement("INSERT INTO `exams`(`qid`,`question`,`op1`,`op2`,`op3`,`op4`,`cop`) VALUES (?,?,?,?,?,?,?)");
            ...
            stat.setString(6, t7.getText());
            stat.setString(7, t8.getText());
